...
public:
	...
	void operator delete (void* pMem)
	{
		const intptr_t index{
			(static_cast<MyManagedObject*>(pMem)-s_ManagedObjects.data()) / static_cast<intptr_t>(sizeof(MyManagedObject))
		};
...
void ThreadTask()
{
	...
	{
		cout << "	"<<i << " thread Output from thread" << endl;
	}
...
int main(int argc, char* argv[])
{
	...
	*/
		...
		cout << "Time Taken: " << timeTaken.count()<< " micro seconds." << endl;
		cout << endl;
